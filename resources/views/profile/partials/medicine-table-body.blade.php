                    ...
                    >
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="medicine_name" value="{{ $medicine->medicine_name }}"
                                class="w-full border-accent-dark px-3 py-2 rounded mt-1 focus:outline-none focus:outline-none focus:ring-2 focus:ring-accent-dark">
                        </div>

                        <div class="mb-4">
                            <label class="block text-gray-700">Brand</label>
                            <input type="text" name="brand_name" value="{{ $medicine->brand_name }}"
                                class="w-full border-accent-dark px-3 py-2 rounded mt-1 focus:outline-none focus:ring-2 focus:ring-accent-dark">
                        </div>
