   @forelse ($Account as $account)
                        ...
                        <tr class="text-text-base hover:bg-gray-100 transition duration-150 ease-in-out">
                            <td class="px-6 py-4 text-text-base\\">{{ $account->name  }}</td>
   ...
   <div class="flex items-center gap-3" x-data="{ showEditModal: false }">
                                ...
                                <button  data-id="{{ $account->id }}" class="delete-btnss bg-red-200 p-1 rounded-sm hover:bg-red-300 transition duration-150 ease-in-out">
                    ...
                    <div class="grid grid-cols-3 md:grid-cols-2 gap-2">
                            <div class="mb-2">
                                <label class="block text-sm font-medium mb-1">Fullname Name:</label>
                                <input type="text" name="name" value="{{ $account->name }}" class="w-full border-accent-dark px-3 py-2 rounded mt-1 focus:outline-none focus:outline-none focus:ring-2 focus:ring-accent-dark" required>
                            </div>
                            <div class="mb-2">
                                ...
                                <select name="role" class="w-full border-accent-dark px-3 py-2 rounded mt-1 focus:outline-none focus:outline-none focus:ring-2 focus:ring-accent-dark">  
                                    ...
                                    <option value="user" {{ old('role',$account->role) == 'user' ? 'selected' : '' }}>user</option>s
                                </select>
                            </div>
                          
                            <div class="mb-2">
                                <label class="block text-sm font-medium mb-1">Email:</label>
                                <input type="email" name="email" value="{{ $account->email }}" class="w-full border-accent-dark px-3 py-2 rounded mt-1 focus:outline-none focus:outline-none focus:ring-2 focus:ring-accent-dark">
                            </div>
